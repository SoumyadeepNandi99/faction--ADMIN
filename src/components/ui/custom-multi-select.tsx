...
export function CustomMultiSelect({ options, value, onChange, placeholder = "Select...", className, disabled }: CustomMultiSelectProps) {
    ...
    const label =
        ...
        selectedOptions.length <= 2 ? selectedOptions.map((o) => o.label).join(", ") :
    ...
    return (
        <div className={cn("relative w-full", className)}>
            ...
            >
                ...
                <ChevronDown className={cn("h-4 w-4 text-muted-foreground transition-transform shrink-0 ml-2", isOpen && "rotate-180")} />
            </button>
                        ...
                        return (
                            ...
                            >
                                <span style={{
                                    ...
                                    color: checked ? "var(--primary)" : "var(--card-foreground)",
                                }}>
                                    {option.label}
                                </span>
                                {checked && <Check className="h-4 w-4" style={{ color: "var(--primary)" }} />}
                            </button>
                        );
                    })}
                </div>,
